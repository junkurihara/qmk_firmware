...
[_QWERTY] = LAYOUT_ortho_4x12(
      ...
      KC_ESC,  ADJUST,  KC_LGUI, KC_LALT, LOWER,   KC_SPC,                    KC_ENT,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_LOWER] = LAYOUT_ortho_4x12( \
      ...
      _______, KC_F11,  KC_F12,  _______, _______, _______,                   _______, _______, _______, KC_HOME, KC_END,  _______, \
   ...
   */
    [_ADJUST] =  LAYOUT_ortho_4x12( \
      ...
      _______, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, _______,                   _______, KC_END,  KC_PGDN, KC_DOWN, _______,  _______,\
  ...
  switch (keycode) {
    case TYPEQ:
      if (record->event.pressed) {
        set_single_persistent_default_layer(_TYPEQ);
      }
      return false;
      break;
    case QWERTY:
