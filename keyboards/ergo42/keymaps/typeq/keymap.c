...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * |  `   | Lang1| Lang2| LAlt | LGUI | META |Space |   | META | SYMB |  \   | RGUI | RAlt |  [   |  ]   | 
   * `------------------------------------------------'   `------------------------------------------------'
   */
  [BASE] = LAYOUT( \
    ...
    KC_GRV,   KC_LANG1, KC_LANG2, KC_LALT, KC_LGUI, MO(META), KC_SPC, MO(META), MO(SYMB), KC_BSLS, KC_RGUI, KC_RALT, KC_LBRC, KC_RBRC \
  ),
  ...
  [META] = LAYOUT( \
    ...
    S(KC_GRV), _______, _______, _______, _______, _______, _______, _______, _______, S(KC_BSLS), _______, _______, S(KC_LBRC), S(KC_RBRC) \
  ),
   ...
   */
  [CURS] = LAYOUT( \
    _______,   _______, S(KC_1), S(KC_2), S(KC_3), S(KC_4), S(KC_5), S(KC_6), S(KC_7), S(KC_8),    S(KC_9),   S(KC_0), KC_UP,      KC_DELETE, \
    _______,   _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME,    KC_PGUP,   KC_LEFT, KC_RGHT,    _______, \
    _______,   _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_END,     KC_PGDOWN, KC_DOWN, S(KC_EQL),  _______, \
    S(KC_GRV), _______, _______, _______, _______, _______, _______, _______, _______, S(KC_BSLS), _______,   _______, S(KC_LBRC), S(KC_RBRC) \
  )
